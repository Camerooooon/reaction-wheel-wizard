...
void loop() {
  ...
  Serial.printf("ROLL -> err: %d deg command: %d amps setpoint: %d deg", roll_error, roll_command, DESIRED_ROLL);
  Serial.printf("PITCH -> err: %d deg command: %d amps setpoint: %d deg", pitch_error, pitch_command, DESIRED_PITCH);
